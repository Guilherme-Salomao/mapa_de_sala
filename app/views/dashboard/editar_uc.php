<?php
    ...
    $formAction = '/mapa_de_sala/public/?page=ucs&action=atualizar';
    ...
    $botaoTopoLink = '/mapa_de_sala/public/?page=ucs';
...
<head>
  ...
  <title>Editar UC - Sistema de Controle de Salas</title>
...
<body>
  ...
  if (pageTitle) pageTitle.textContent = "Editar UC";
